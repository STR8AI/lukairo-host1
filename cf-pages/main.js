...
if (canvas instanceof HTMLCanvasElement) {
  ...
  if (ctx) {
    const GLOBE_CONFIG = {
      ...
      polarBiasProbability: 0.5,
      latFalloff: 0.4,
      globeScale: 0.28,
      latitudeLineRadius: 0.28,
      longitudeSpeedMultiplier: 120,
      globeRotationSpeed: 0.2,
      pointCount: 180,
      baseSpeed: 0.0008,
    ...
    function biasedLatitude() {
      const latScale =
        Math.random() > GLOBE_CONFIG.polarBiasProbability ? 1 : GLOBE_CONFIG.latFalloff;
    ...
    function drawGlow() {
      ...
      gradient.addColorStop(0, "rgba(69,215,255,0.20)");
      gradient.addColorStop(0.45, "rgba(118,245,208,0.10)");
      gradient.addColorStop(1, "rgba(3,12,24,0)");
